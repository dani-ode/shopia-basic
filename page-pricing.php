      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow">
          ...
          <div class="card-body">
            ...
            <button type="button" class="w-100 btn btn-lg btn-outline text-primary text-white">Sign up for free</button>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card mb-4 rounded-3 shadow">
          ...
          <div class="card-body">
            ...
            <button type="button" class="w-100 btn btn-lg bg-primary text-white">Get started</button>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card mb-4 rounded-3 shadow ">
          <div class="card-header py-3 text-white bg-addition">
          ...
          <div class="card-body">
            ...
            <button type="button" class="w-100 btn btn-lg bg-primary text-white">Contact us</button>
          </div>
        </div>
      </div>
    </div>
      ...
      <table class="table text-center">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td></td>
            <td><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2" viewBox="0 0 16 16"><path d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z"/></svg>
            </td>
            <td>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check2" viewBox="0 0 16 16"><path d="M13.854 3.646a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L6.5 10.293l6.646-6.647a.5.5 0 0 1 .708 0z"/></svg>
            </td>
